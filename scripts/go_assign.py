...
with open('/users/r/b/rbrennan/tonsa_f20/analysis/heterozygosity_output.txt') as master_file:
...
np.savetxt('/users/r/b/rbrennan/tonsa_f20/analysis/heterozygosity_GOterms.out', go_df,fmt='%5s', delimiter='\t')
